...
def main():
    ...
    keysize, key_bv = 256, BitVector(textstring="anexaminedlifeistrulyworthliving")
    if keysize == 128:    
...
if __name__ == "__main__":
    #print(list(map(lambda x: int(x), gen_key_schedule_256(BitVector(filename="key.txt")))))
    #print(len(gen_key_schedule_256(BitVector(textstring="anexaminedlifeistrulyworthliving"))))
    main()